	...
	#define STR0032 "Lista de Precios (Base)"
	...
	#else
		#define STR0001 "Listagem de Precos"
		...
		#define STR0010 "Inter-Esta"
		#define STR0011 "Norte/Nord"
		#define STR0012  "Todos"
		#define STR0013 " CODIGO           DESCRICAO  DO  PRODUTO         UM       QTD P/                    PRECO"
		#define STR0014 "                                                          EMBAL.                     BASE"
		#define STR0015  "Por Tipo"
		#define STR0016  "Por Grupo"
		#define STR0017 "Este relatorio ira imprimir as tabelas de precos de acordo"
		#define STR0018 "com os parametros informados pelo usuario"
		#define STR0019 "Por Descricao do Produto"
		#define STR0020 "Selecionando Registros"
		#define STR0021 "TIPO "
		#define STR0022 "GRUPO"
		#define STR0023 "Por produto"
		#define STR0024 "Listagem de Precos"
		#define STR0025  "Este relatório irá imprimir as tabelas de preços de acordo com os parâmetros informados pelo usuário"
		#define STR0026 "Tabela de Preço"
		#define STR0027  "Tipo"
		#define STR0028  "Grupo"
		#define STR0029 "Descrição de produto"
		#define STR0030 "Código de produto"
		#define STR0031 "Produtos da tabela de preço"
		#define STR0032 "Lista de Preços ( Base )"
	#endif
#endif
